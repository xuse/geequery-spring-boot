...
/**
 * Integration test with custom filter for {@link GeeQueryTest}.
 */
@RunWith(SpringRunner.class)
@GeeQueryTest(includeFilters = @ComponentScan.Filter(Component.class), excludeFilters = @ComponentScan.Filter(Service.class))
@TestPropertySource(properties = {
  "geequery.repos=com.github.geequery.springboot.test",
  "geequery.packagesToScan=com.github.geequery.springboot.test"
})
public class GeeQueryTestCustomFilterIntegrationTest {
