 ...
 * for a typical geequery test. Can be used when a test focuses <strong>only</strong> on
 * geequery-based components.
 * <p>
 * Using this annotation will disable full auto-configuration and instead apply only
 * configuration relevant to geequery tests.
 * <p>
...
@TypeExcludeFilters(GeeQueryTypeExcludeFilter.class)
@Transactional
@AutoConfigureCache
@AutoConfigureGeeQuery
@AutoConfigureTestDatabase
@ImportAutoConfiguration
public @interface GeeQueryTest {
